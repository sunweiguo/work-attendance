package com.oursnail.register.controller;
...
public class RegisterController {
    ...
    public String regist(HttpServletRequest request) throws UnsupportedEncodingException, NoSuchAlgorithmException, WxRecordException {
        try{
...
//      从数据库查询是否存在这个邮箱
    ...
    public String active(@RequestParam String code) throws WxRecordException {
        try{
            if(StringUtils.isBlank(code)){
                log.error("用户code为空");
                throw new WxRecordException("用户激活邮件的参数有问题");
            }
